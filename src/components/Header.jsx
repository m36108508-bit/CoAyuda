    ...
    <header className="sticky top-0 z-30 bg-white text-slate-800 shadow-sm border-b border-slate-200">
      <div className="max-w-2xl mx-auto px-4 py-3">
        ...
        <div className="mt-3 flex items-center justify-between gap-2 rounded-xl border border-red-200 bg-red-50 px-3 py-2">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wide text-red-700">Emergencia</p>
            <p className="text-xs text-red-800">Si hay riesgo inmediato, llama a emergencias</p>
          </div>
          <a
            href="tel:123"
            className="inline-flex items-center justify-center rounded-lg bg-red-600 px-3 py-2 text-xs font-bold text-white shadow-sm"
          >
            🚨 Llamar 123
          </a>
        </div>
